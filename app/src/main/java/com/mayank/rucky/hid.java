...
class hid {
    ...
    private void defineTR() {
        keycodes.put("ASCII_20",kbbyteCode(keys.get("KEY_SPACE")));
        keycodes.put("ASCII_21",kbbyteCode(keys.get("KEY_1"),keys.get("MODIFIERKEY_SHIFT")));
        keycodes.put("ASCII_22",kbbyteCode(keys.get("KEY_TILDE")));
    ...
    private void defineSV() {
        ...
        keycodes.put("ISO_8859_1_A7",kbbyteCode(keys.get("KEY_TILDE")));
        ...
        keycodes.put("ISO_8859_1_BD",kbbyteCode(keys.get("KEY_TILDE"),keys.get("MODIFIERKEY_SHIFT")));
